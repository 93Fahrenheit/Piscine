...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/21 17:58:17 by fael-abb          #+#    #+#             */
/*   Updated: 2025/08/21 18:26:15 by fael-abb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_itoa_base(long value, char *base, char *dst, int res_len)
{
	int				base_len;
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	res = malloc(count_digits(value, base_to_len) + 1);
	if (!res)
		return (0);
	ft_itoa_base(value, base_to, res, (count_digits(value, base_to_len)));
	return (res);
}
/*
int	main(void)
